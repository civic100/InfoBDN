       ...
       if(!empty ($_SESSION['dniprofesor']))  {
        ...
        <div class="Contenedor-Tabla">
                ...
                if($conexion == false){
                    ...
                    $sql = "SELECT cursos.nombre,cursos.codigo,matricula.dni_alumno ,matricula.nota,cursos.fechafinal FROM cursos INNER JOIN matricula ON cursos.codigo=matricula.curso where cursos.profesor='$id'";
